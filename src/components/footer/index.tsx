...
function Footer() {
    return (
        <div className="istem-footer-box">
            <div className="section_15 flex-row">
                <div className="block_11 flex-col justify-between">
                    <div className="group_13 flex-row justify-between">
                        <div className="image-text_11 flex-row justify-between">
                            ...
                            <span className="text-group_8">AI-STEM</span>
                        </div>
                        <div className="section_16 flex-col" />
                    </div>
                    <div className="text-wrapper_4 flex-col">
                        <span className="text_28">本资料所表达的任何观点、发现、结论或建议均为作者个人观点。</span>
                    </div>
                </div>
                <img
                    className="image_11"
                ...
                />
                <div className="block_12 flex-col justify-between">
                    <img
                        className="image_13"
                        src={
                    ...
                    />
                    <div className="image-wrapper_4 flex-row">
                        <img
                            className="label_11"
                            src={
